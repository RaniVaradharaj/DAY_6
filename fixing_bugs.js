...
alert(`World`)  // missing semicolon
alert(3 +
1
+ 2); // this is multiple line code


// //Fix the below to alert Guvi geek
var admin=9, fname=10.5; //used var to declare or reassign
fname = "Guvi";
lname = "geek"
admin = fname+" "+lname; 
...
var msg = "";
if (lemein) {
msg += "hi";  //O/P will be hi since the assigned value initially will be taken as string
}
if (lemeout) {
msg += "Hello";
}
